...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user1 = (User) getIntent().getSerializableExtra("selected_user");
        ...
        Set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resultIntent.putExtra("selected_user", user1);
                setResult(RESULT_OK, resultIntent);
                finish(); // this will return to HomeActivity

            }
        });


        switch1.setChecked(user1.getDoNotDisturb()==1);
        switch1.setOnCheckedChangeListener((buttonView, isChecked) -> {
            DoNotDisturbHelper.setDoNotDisturb(SettingsActivity.this, isChecked);
            if (isChecked){user1.setDoNotDisturb(1); }
            else {user1.setDoNotDisturb(0); }
